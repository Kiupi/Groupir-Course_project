...
INSERT INTO user (user_id, birth_date, email, first_name, last_name, password, default_address_address_id, role_role_id,enabled) VALUES (2, null, 'cyril.faisandier@telecom-st-etienne.fr', 'Cyril', 'Faisandier', '0000', null, 1,true);
INSERT INTO user (user_id, birth_date, email, first_name, last_name, password, default_address_address_id, role_role_id,enabled) VALUES (3, null, 'baptiste.wolf@telcom-st-etienne.fr', 'Baptiste', 'Wolf', '0000', null, 2,true);
INSERT INTO user (user_id, birth_date, email, first_name, last_name, password, default_address_address_id, role_role_id,enabled) VALUES (4, null, 'raphael.chevasson@telecom-st-etienne.fr', 'Raphaël', 'Chevasson', '0000', null, 2,true);
INSERT INTO user (user_id, birth_date, email, first_name, last_name, password, default_address_address_id, role_role_id,enabled) VALUES (5, null, 'julien.subercaze@telecom-st-etienne.fr', 'Julien', 'Subercaze', '0000', null, 3,true);
INSERT INTO user (user_id, birth_date, email, first_name, last_name, password, default_address_address_id, role_role_id,enabled) VALUES (6, null, 'jacques.fayolle@telecom-st-etienne.fr', 'Jacques', 'Fayolle', '0000', null, 3,true);
